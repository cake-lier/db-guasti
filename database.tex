...
\begin{table}[H]
	...
	%	\hline
		Cliente & 1 & S\\
		\hline
	%	Motivazione & 13.220 / 13.200 = 1,002 & S\\
	%	\hline
		Guasto & 13.220 / 13.200 = 1,002 & S\\
		\hline
	%	Effetto & 1,002 & S\\
	%	\hline
		...
		\hline
		\hline
		TOTALE & \multicolumn{2}{>{\hsize=2\hsize}X}{ 8,008 accessi }\\
		\hline
		\hline
		TOTALE MENSILE & \multicolumn{2}{>{\hsize=2\hsize}X}{ 8,008 * 5 accessi/giorno * 30 giorno/mese = 1201,2 accessi/mese }\\
		\hline
		\hline
	\end{tabularx}
	...
	\begin{tabularx}{\linewidth}{X|X|X}
		...
		Guasto & 13.220 & L\\
		\hline
	%	Motivazione & 13.220 & L\\
	%	\hline
		Intervento & 13.220 & L\\
		\hline
		\hline
		TOTALE & \multicolumn{2}{>{\hsize=2\hsize}X}{ 26.440 accessi }\\
		\hline
		\hline
		TOTALE MENSILE & \multicolumn{2}{>{\hsize=2\hsize}X}{ 26.440 * 5 accessi/mese = 132.200 accessi/mese }\\
		\hline
		\hline
	\end{tabularx}
\end{table}
